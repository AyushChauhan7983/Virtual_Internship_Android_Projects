...
private val forageableDao: ForageableDao
    ...
    val forageables: LiveData<List<Forageable>> = forageableDao.getAllForgeables().asLiveData()
    ...
    fun getForageable(id:Long):LiveData<Forageable> =
        forageableDao.getForgeableById(id).asLiveData()
    ...
    // TODO: launch a coroutine and call the DAO method to add a Forageable to the database within it
        viewModelScope.launch {
                forageableDao.insertForgeables(forageable)
        }
    ...
    fun updateForageable(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            forageableDao.updateForgeable(forageable)
        }
    }
    ...
    fun deleteForageable(forageable: Forageable) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            forageableDao.deleteForgeable(forageable)
        }
    }
