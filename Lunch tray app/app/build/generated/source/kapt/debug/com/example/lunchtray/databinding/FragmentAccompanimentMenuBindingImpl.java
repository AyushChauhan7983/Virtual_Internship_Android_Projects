        ...
        switch(sourceId) {
            ...
            case 2: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    if (viewModelMenuItemsJavaLangObjectNull) {
                        ...
                        viewModel.setAccompaniment(viewModelMenuItemsBerries);
                    }
                }
                break;
            }
            case 5: {
                ...
                if (accompanimentMenuFragmentJavaLangObjectNull) {
                    ...
                    accompanimentMenuFragment.goNextScreen();
                }
                break;
            }
            case 3: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    if (viewModelMenuItemsJavaLangObjectNull) {
                        ...
                        viewModel.setAccompaniment(viewModelMenuItemsPickles);
                    }
                }
                break;
            }
            case 1: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    if (viewModelMenuItemsJavaLangObjectNull) {
                        ...
                        viewModel.setAccompaniment(viewModelMenuItemsBread);
                    }
                }
                break;
            }
