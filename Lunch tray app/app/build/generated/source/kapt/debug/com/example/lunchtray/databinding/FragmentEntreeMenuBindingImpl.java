        ...
        switch(sourceId) {
            case 2: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    if (viewModelMenuItemsJavaLangObjectNull) {
                        ...
                        viewModel.setEntree(viewModelMenuItemsChili);
                    }
                }
                break;
            }
            case 6: {
                ...
                if (entreeMenuFragmentJavaLangObjectNull) {
                    ...
                    entreeMenuFragment.goNextScreen();
                }
                break;
            }
            case 3: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    if (viewModelMenuItemsJavaLangObjectNull) {
                        ...
                        viewModel.setEntree(viewModelMenuItemsPasta);
                    }
                }
                break;
            }
            case 4: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    if (viewModelMenuItemsJavaLangObjectNull) {
                        ...
                        viewModel.setEntree(viewModelMenuItemsSkillet);
                    }
                }
                break;
            }
            case 1: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    if (viewModelMenuItemsJavaLangObjectNull) {
                        ...
                        viewModel.setEntree(viewModelMenuItemsCauliflower);
                    }
                }
                break;
            }
